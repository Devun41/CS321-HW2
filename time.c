...
int main(int argc, char *argv[])
{
	...
	//shm_open opens a shared POSIX memory
...
//used to map shared memory to the pointer, 0 means default/auto location
    ...
    pid = fork();
//start child process and save the time of day to start
    if (pid == 0)
    {
        // child
